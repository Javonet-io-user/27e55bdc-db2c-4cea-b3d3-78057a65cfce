...
public class Signature implements IEquatable<Signature> {
  ...
  public DateTimeOffset getWhen() {
    try {
      Object res = javonetHandle.<NObject>get("When");
      if (res == null) return null;
      return new DateTimeOffset((NObject) res);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public Signature(java.lang.String name, java.lang.String email, DateTimeOffset when) {
    try {
      javonetHandle = Javonet.New("LibGit2Sharp.Signature", name, email, when);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public Signature(Identity identity, DateTimeOffset when) {
    try {
      javonetHandle = Javonet.New("LibGit2Sharp.Signature", identity, when);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public Signature(NObject handle) {
  ...
  public java.lang.Boolean Equals(Signature other) {
    try {
