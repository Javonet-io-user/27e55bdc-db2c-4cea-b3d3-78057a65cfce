...
public abstract class Filter implements IEquatable<Filter> {
  ...
  public IEnumerable<FilterAttributeEntry> getAttributes() {
    try {
  ...
  public java.lang.Boolean Equals(Filter other) {
    try {
