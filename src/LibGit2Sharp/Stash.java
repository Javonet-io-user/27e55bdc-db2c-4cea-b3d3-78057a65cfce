...
public class Stash extends ReferenceWrapper<Commit>
    implements IEquatable<ReferenceWrapper<Commit>>, IBelongToARepository {
  protected NObject javonetHandle;
  /** GetProperty */
  public Commit getWorkTree() {
    try {
      Object res = javonetHandle.<NObject>get("WorkTree");
