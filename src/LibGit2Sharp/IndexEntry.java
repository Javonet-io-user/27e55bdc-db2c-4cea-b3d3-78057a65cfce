...
public class IndexEntry implements IEquatable<IndexEntry> {
  ...
  public StageLevel getStageLevel() {
    try {
      Object res = javonetHandle.<NEnum>get("StageLevel");
      if (res == null) return null;
      return StageLevel.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public java.lang.Boolean getAssumeUnchanged() {
    try {
      java.lang.Boolean res = javonetHandle.get("AssumeUnchanged");
  ...
  public IndexEntry() {
    try {
      javonetHandle = Javonet.New("LibGit2Sharp.IndexEntry");
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public IndexEntry(NObject handle) {
  ...
  public java.lang.Boolean Equals(IndexEntry other) {
    try {
