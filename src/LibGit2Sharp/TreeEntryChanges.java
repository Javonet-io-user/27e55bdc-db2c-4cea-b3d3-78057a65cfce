...
public class TreeEntryChanges {
  ...
  public java.lang.Boolean getExists() {
    try {
      java.lang.Boolean res = javonetHandle.get("Exists");
  ...
  public java.lang.Boolean getOldExists() {
    try {
      java.lang.Boolean res = javonetHandle.get("OldExists");
      if (res == null) return false;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
  ...
  public TreeEntryChanges(NObject handle) {
