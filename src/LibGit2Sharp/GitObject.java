...
public abstract class GitObject implements IEquatable<GitObject>, IBelongToARepository {
  ...
  public GitObject(NObject handle) {
  ...
  public java.lang.Boolean Equals(GitObject other) {
    try {
