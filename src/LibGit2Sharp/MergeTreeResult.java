...
public class MergeTreeResult {
  ...
  /** GetProperty */
  public MergeTreeStatus getStatus() {
    try {
      Object res = javonetHandle.<NEnum>get("Status");
      if (res == null) return null;
      return MergeTreeStatus.valueOf(((NEnum) res).getValueName());
  ...
  public IEnumerable<Conflict> getConflicts() {
    try {
  ...
  public MergeTreeResult(NObject handle) {
